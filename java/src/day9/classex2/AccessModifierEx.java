...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//AccessModifier 클래스와 A 글래스는 같은 패키지에 있는 클래스
		//AccessModifier 클래스와 B 글래스는 다른 패키지에 있는 클래스
		//num3은 접근제어자가 public. 같은 패키지이든 아니든 상관 없음
		a.num3 = 10;
		b.num3 = 20;
		
		//num2는 접근제어자가 디폴트(생략됨). 
		//다른 패키지에 있는 B 클래스의 객체에 있는 num2는 접근이안됨
		a.num2 = 10;
		//b.num2 = 20;
...
class A {
	...
	//privated으로 된 num1에 값을 변경하기 위해서 setter를 추가
