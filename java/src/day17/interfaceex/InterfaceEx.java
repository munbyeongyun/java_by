...
public class InterfaceEx {
	...
	public static void main(String[] args) {
		...
		runInterface.run();
		// RunOnterface에는 load가 추상메서드로 존재하지 않기 때문에 에러발생
		// runInterface.load(); 
		// 아래 코드는 Run클래스의 객체로 클래스변환이 됐기 때문에 load()메서드 호출 가능
	 ...
	 *  구현 클래스인 ShopManager, VocabularyNoteController의 객체가 와서 실행가능.
	 * */
